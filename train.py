...
def main(args):
    ...
    base_lr = opt.state_dict()['param_groups'][0]['lr']
    print('lr:', base_lr)
    ...
    if cfg.resume:
        amp.load_state_dict(checkpoint['grad_scaler_state_dict'])
    ...
    for epoch in range(start_epoch, cfg.num_epoch):
        ...
        if rank == 0:
            ...
            torch.save({
              ...
              'grad_scaler_state_dict':  amp.state_dict(),
              'epoch': epoch,
